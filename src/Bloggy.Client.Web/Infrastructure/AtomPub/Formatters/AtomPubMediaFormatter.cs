...
namespace Bloggy.Client.Web.Infrastructure.AtomPub.Formatters
{
    public class AtomPubMediaFormatter : BufferedMediaTypeFormatter
    {
        ...
        {
            Atom10FeedFormatter formatter = new Atom10FeedFormatter(feed.Syndicate());
        ...
        {
            SyndicationItem entry = publication.Syndicate();

            Atom10ItemFormatter formatter = new Atom10ItemFormatter(entry);

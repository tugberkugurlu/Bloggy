...
namespace Bloggy.Client.Web.Infrastructure.AtomPub.Dispatchers
{
    public class AtomPubServiceDocumentDispatcher : HttpMessageHandler
    {
        public AtomPubServiceDocumentDispatcher()
        {
        }
        ...
        protected override Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken cancellationToken)
        {
            ...
            AtomPub10ServiceDocumentFormatter formatter = new AtomPub10ServiceDocumentFormatter(doc);
